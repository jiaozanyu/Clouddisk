...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">添加好友</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form id="tab" action="AddUser" method="post">
    <input type="text" value="${manager.id}" style="display:none"  class="input-xlarge" name="applicant.applicant">
        <label>请输入好友账号</label>
        <input name="applicant.beapplicant" value="" class="input-xlarge" type="text">*
