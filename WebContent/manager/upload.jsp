   ...
   <%@ include  file="menu.jsp"%> 
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li><a href="users.html">资源分享</a> <span class="divider">/</span></li>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">上传资源给他</a></li>
    ...
    <form id="tab" action="upload" enctype="multipart/form-data" method="post">
        <label>学生学号</label>
        <input type="text" value="${param.id }" class="input-xlarge" name="uid">
         <label>资源名字</label>
